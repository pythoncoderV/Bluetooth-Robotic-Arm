//This code is for uploading to the client ESP-WROOM-32 microcontroller through Arduino IDE:
...
//then wirelessly transmits this data to the server ESP-WROOM-32 microcontroller. If the Bluetooth connection is lost, the client 
//continues attempting to reconnect. Upload this code into the SERVER ESP-WROOM-32 microcontroller at the same time you upload the 
//CLIENT ESP-WROOM-32 microcontroller code for a stable connection.
