...
The client uses an ESP-WROOM-32 microcontroller, a 5 pin 2 axis(x,y) Push Button Joystick, and a 2 pin switch. I will connext a 3.7V 300mA LiPo battery through the 
